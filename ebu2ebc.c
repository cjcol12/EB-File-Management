/* 
    @file ebu2ebc.c
    @brief Program to read a .ebu file and convert it to a .ebc file.

    This program reads a .ebu file, performs compression on its contents, and writes them to a .ebc file.

    Usage: ./ebu2ebc input_file.ebu output_file.ebc
...
int main(int argc, char **argv)
{
    ...
    // Divides data by compression ratio (1.6) and rounds up to ensure enough bytes are allocated
    ...
    // compresses data into ebc format and writes it to output file
